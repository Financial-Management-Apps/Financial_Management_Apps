...
const Income = () => {
  ...
  const [categoryFilter, setCategoryFilter] = useState('Salary'); // Lọc theo danh mục
  ...
  // Tính thu nhập theo từng tháng cho mỗi loại thu nhập
  const incomeByMonth = Array.from({ length: 12 }, (_, index) => {
    const month = index + 1;
    ...
    <Box sx={{ padding: 4 }}>
      ...
      <FormControl size="small" sx={{ minWidth: 200, marginBottom: 2 }}>
        ...
        >
          ...
          <MenuItem value="Investments">Đầu tư</MenuItem>
        </Select>
      </FormControl>
      ...
      {selectedMonth && (
        <>
          <Typography variant="h6" sx={{ marginTop: 3 }}>
            Chi tiết thu nhập tháng {selectedMonth}
          </Typography>
          <List>
